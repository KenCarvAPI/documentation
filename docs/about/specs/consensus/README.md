---
description: Gnosis Chain consensus - Proof of Stake with the Gnosis Beacon Chain
keywords: [gnosis consensus, proof of stake, pos, gasper, gnosis beacon chain]
---

# Consensus: Proof of Stake

Gnosis Chain uses Proof of Stake consensus, secured by the [GNO token](/about/tokens/gno) on the Gnosis Beacon Chain, since [The Merge](/about/specs/consensus/history/the-merge) in December 2022. The deprecated pre-merge models (AuRa, POSDAO) are documented under [History](/about/specs/consensus/history/the-merge).
