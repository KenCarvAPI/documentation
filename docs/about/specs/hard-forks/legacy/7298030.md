...
1. **You must update spec.json and Parity node to version 2.6.5** as the spec format was changed. [Use this guide to upgrade](/about/specs/hard-forks/legacy/spec.json-update).
