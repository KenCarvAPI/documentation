...
- Chiado's secondary purpose was to test "The Merge", Gnosis' transition from [Proof-of-Authority](../../about/specs/consensus/history/aura.md) to the [Beacon Chain](../../about/specs/contracts-and-addresses.md).
