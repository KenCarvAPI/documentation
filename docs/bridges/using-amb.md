...
2. Go to the [AMB helper contract](https://gnosis.blockscout.com/address/0x7d94ece17e81355326e3359115D4B02411825EdD) and call `getSignatures()` there with the encoded data from the `UserRequestForSignature` event. It will produce a blob with signatures.
