...
description: Gnosis Chain node and validator FAQ - offline and sync issue. Archived - previously published at /faq/Node FAQs/offlineAndSyncIssue.
keywords: [node, validator, faq, archived]
---

# Offline and Sync Issue (Archived)
