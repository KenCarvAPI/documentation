...
description: Gnosis Chain node and validator FAQ - monitoring and alerts. Archived - previously published at /faq/Node FAQs/monitoring.
keywords: [node, validator, faq, archived]
---

# Monitoring and Alerts (Archived)
